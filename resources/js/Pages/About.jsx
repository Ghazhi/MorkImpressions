...
export default function About() {
    return (
        <>
            ...
            {/*==================================================*/}
            <div className="about-serction style-two">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-6 pl-0 pr-25">
                            <div className="about-thumb">
                                <img src="template/assets/images/resource/about.png" alt="" />
                                {/* about shape */}
                                <div className="about-shape bounce-animate">
                                    <img src="template/assets/images/resource/ab-shape.png" alt="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row demand-bg">
                            <div className="col-lg-12">
                                <div className="demand-title">
                                    <h2> Printed and shipped on demand! </h2>
                                    <h5>Printed and shipped on demand!</h5>
                                </div>
                                {/* counter button */}
                                <div className="print-button style-two">
                                    <a href="#">
                                        {" "}
